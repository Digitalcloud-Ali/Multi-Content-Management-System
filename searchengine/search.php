...
</div><div style="float:right; padding:0; padding-top:10px; width:80%;position: relative;">
...
<?php if ($totalRows_searchengine > 0) { // Show if recordset not empty ?>
                  <?php do { ?>
<div style="height:2px;"><a href="<?php echo $row_searchengine['siteurl']; ?>" class="admintitle"><?php echo $row_searchengine['title']; ?></a></div><br /><div style="height:2px;" class="searchenginegreen"><?php echo $row_searchengine['siteurl']; ?></div><br />
<div style="height:2px;" class="texts"><?php echo $row_searchengine['metadesc']; ?></div><br /><br />
                    <?php } while ($row_searchengine = mysqli_fetch_assoc($searchengine)); ?>
                  <?php } // Show if recordset not empty ?>
                <?php if ($totalRows_searchengine == 0) { // Show if recordset empty ?>
                  No Results Found
                  <?php } // Show if recordset empty ?>
                  <div align="center"><a href="<?php printf("%s?pageNum_searchengine=%d%s", $currentPage, 0, $queryString_searchengine); ?>" class="navigationbuttons">FIRST</a> <a href="<?php printf("%s?pageNum_searchengine=%d%s", $currentPage, max(0, $pageNum_searchengine - 1), $queryString_searchengine); ?>" class="navigationbuttons">PREVIOUS</a> <a href="<?php printf("%s?pageNum_searchengine=%d%s", $currentPage, min($totalPages_searchengine, $pageNum_searchengine + 1), $queryString_searchengine); ?>" class="navigationbuttons">NEXT</a> <a href="<?php printf("%s?pageNum_searchengine=%d%s", $currentPage, $totalPages_searchengine, $queryString_searchengine); ?>" class="navigationbuttons">LAST</a></div>
