...
<div class="title">JUST ARRIVED</div>
                  <?php do { ?>
                  <table>
                    <tr>
                  ...
                  <div class="title">FEAUTRED</div>
                  <?php do { ?>
                  <table>
                      <tr>
                        <td width="1"><a href="adposting.php?adpostingid=<?php echo $row_featuredadposts['adpostingid']; ?>"><img src="images/adposting/<?php echo $row_featuredadposts['imageurl']; ?>" width="40" height="40" border="0"></a></td>
                        <td><a href="adposting.php?adpostingid=<?php echo $row_featuredadposts['adpostingid']; ?>" class="posttitle"><?php echo $row_featuredadposts['title']; ?></a></td>
                      </tr>
                      <tr>
                        <td colspan="2"><?php echo $row_featuredadposts['owner']; ?> / <?php echo $row_featuredadposts['date']; ?> / View : <?php echo $row_featuredadposts['views']; ?> / Rating : / <?php echo $row_featuredadposts['catename']; ?></td>
                      </tr>
                    </table>
