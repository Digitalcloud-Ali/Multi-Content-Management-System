...
<title><?php echo $row_blog['catename']; ?></title>
<meta name="keywords" content="<?php echo $row_blog['catename']; ?>">
<meta name="description" content="<?php echo $row_blog['catename']; ?>">
...
<table class="mainbody">
      <tr>
        ...
        <td valign="top">
		<div class="title"><?php echo $row_blog['catename']; ?></div>
