        ...
        <tr>
          <td valign="top"><div class="title">Search Results</div>
            ...
            <table width="100%">
                    ...
                    <tr>
                      <td colspan="2"><?php echo $row_market['owner']; ?> / <?php echo $row_market['date']; ?> / View : <?php echo $row_market['views']; ?> / Rating : <?php echo $row_market['rating']; ?> / <?php echo $row_market['catename']; ?></td>
                    </tr>
                  </table>
