...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_editorpick = "SELECT * FROM market WHERE editorpick = 'yes' ORDER BY marketid DESC";
...
<?php include($theme_path."".$row_setting['theme']."/header.php"); ?><table class="mainbody">
 ...
 <table class="tables">
              <tr>
                <td><table width="100%">
                  <tr>
                    ...
                    <td align="center"><strong>TIME LEFT</strong></td>
                  </tr>
                    <?php do { ?>
                      <tr>
                        ...
                        <td align="center"><span><a href="category.php?catename=<?php echo $row_market['catename']; ?>"><?php echo $row_market['catename']; ?></a></span></td>
                        <td align="center"><?php echo $row_market['date']; ?></td>
                      </tr>
                      <?php } while ($row_market = mysqli_fetch_assoc($market)); ?>
                </table>
                  <div class="title">FEATURED MARKET PRODUCTS</div>
                  <table width="100%">
  <tr>
    <td><strong>PRODUCT NAME</strong></td>
    <td align="center"><strong>PRICE</strong></td>
  ...
  <?php do { ?>
  <tr>
    <td><a href="market.php?marketid=<?php echo $row_featuredadposts['marketid']; ?>"><?php echo $row_featuredadposts['title']; ?></a></td>
    ...
    <td align="center"><span><a href="category.php?catename=<?php echo $row_featuredadposts['catename']; ?>"><?php echo $row_featuredadposts['catename']; ?></a></span></td>
