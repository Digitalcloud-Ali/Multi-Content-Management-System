                      ...
                      <td colspan="2"><div class="title">Create New Post</div>
                        <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="adpost" id="adpost"><table>
                            <tr>
                              ...
                              <td><input name="title" type="text" class="form" id="title" required="required" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td><input name="dates" type="number" class="formmenusimple" id="dates" value="<?php print(Date("d-m-Y")); ?>" required="required" />
                                <span class="textsmall">FORMAT : DD-MM-YYYY</span></td>
                            </tr>
                            <tr>
                              <td class="texts"><strong>IMAGE:</strong></td>
...
do {  
?>
                              <option value="<?php echo $row_cates['catename']?>"<?php if (!(strcmp($row_cates['catename'], $row_cates['catename']))) {echo "selected=\"selected\"";} ?>><?php echo $row_cates['catename']?></option>
                              <?php
