...
if (isset($_GET['adpostingid'])) {
  $colname_rsM = $_GET['adpostingid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_rsM = sprintf("SELECT * FROM adposting WHERE adpostingid = %s", GetSQLValueString($colname_rsM, "int"));
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_rsT = "SELECT * FROM adposting ORDER BY adpostingid DESC";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "add")) {
   ...
   // UPLOAD CODE BY SYED RAZA ALI START //
	...
	$max_filesize = 5250000;
  	$upload_path = '../adposting/images/adposting/';
  ...
  $insertSQL = sprintf("INSERT INTO adposting (title, `description`, imageurl, adpostingurl, owner, `date`, catename, status, rating, views, `position`, editorpick, users) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "update")) {
  ...
  $updateSQL = sprintf("UPDATE adposting SET title=%s, `description`=%s, imageurl=%s, adpostingurl=%s, `date`=%s, catename=%s, status=%s, rating=%s, views=%s, `position`=%s, editorpick=%s, users=%s WHERE adpostingid=%s",
                       GetSQLValueString($_POST['title'], "text"),
                       GetSQLValueString($_POST['description'], "text"),
                       GetSQLValueString($filename, "text"),
                       GetSQLValueString($_POST['adpostingurl'], "text"),
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogoverview = "SELECT * FROM adposting ORDER BY adpostingid DESC";
...
if (isset($_GET['adpostingid'])) {
  $colname_blogupdate = $_GET['adpostingid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogupdate = sprintf("SELECT * FROM adposting WHERE adpostingid = %s", GetSQLValueString($colname_blogupdate, "int"));
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_categorylist = "SELECT * FROM categories WHERE selecttopic = 'adposting'";
...
<title><?php echo $row_setting['title']; ?> - Ad Posting</title>
...
<?php if($row_setting['selecttopic'] == 'custom')
			...
			if($row_contentlinks['status'] == 'active')
              ...
              <td width="700" height="30" align="center" valign="top"><?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td background="images/leftNavBg.png" class="admintitle">ADPOSTING OVERVIEW</td>
                    </tr>
                  </table>
                    ...
                    <tr>
                      <td height="47" align="left" bgcolor="#FFFFFF"><?php if ($totalRows_blogoverview > 0) { // Show if recordset not empty ?>
                          <table width="100%" border="0" cellspacing="2" cellpadding="4">
                            ...
                            <?php do { ?>
                              <tr>
                                <td height="11" align="center" class="smallbut"><div class="textsmallred"><?php echo $row_blogoverview['adpostingid']; ?></div></td>
                                <td bgcolor="#FBFEFF" class="borderorangetable"><div class="texts"><?php echo $row_blogoverview['title']; ?></div></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="adposting.php?adpostingid=<?php echo $row_blogoverview['adpostingid']; ?>" class="textsmallgreen">
                                  <div>Edit</div>
                                </a></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="adposting.php?delete=<?php echo $row_blogoverview['adpostingid']; ?>" class="textsmallred" onClick="javascript:return confirm('Please Confirm Before Delete ?')">
                                  <div>Delete</div>
                                </a></td>
                              </tr>
  ...
  <table width="100%" border="0" cellspacing="2" cellpadding="4">
    <tr class="orangetitle">
      <td width="32" align="center">NO Ad FOUNDED</td>
      </tr>
  </table>
  <?php } // Show if recordset empty ?></td>
                  ...
                  <?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                    <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <td background="images/leftNavBg.png" class="admintitle">ADD NEW AD</td>
                      </tr>
                    </table>
                    <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
...
?>
                            ...
                            <tr>
                              <td height="24" class="texts"><strong>AD Url:</strong></td>
                              <td><input name="adpostingurl" type="text" class="form" id="adpostingurl" /></td>
                            </tr>
                            <tr>
                          ...
                          <input name="selecttopic" type="hidden" id="selecttopic" value="adposting" />
                          <input name="views" type="hidden" id="views" value="0" />
                          <input name="users" type="hidden" id="users" value="<?php echo $row_members['users']; ?>" />
...
 frmvalidator.addValidation("title","alphanumeric");
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#ECCF5E">
    <tr>
      <td align="center" bgcolor="#FAF1D1" class="texts"><a href="adposting.php" class="textsmallred">Back To AdPosting</a></td>
    </tr>
  </table>
  <table width="40" border="0" cellpadding="0" cellspacing="0">
    <tr>
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
      <td background="images/leftNavBg.png" class="admintitle">UPDATE AD</td>
      </tr>
  </table>
                    <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
...
?>
                            ...
                            <tr>
                              <td height="24" class="texts"><strong>IMAGE:*</strong></td>
                              <td><input name="imageurl" type="file" class="formmenusimple" id="imageurl" value="<?php echo $row_blogupdate['imageurl']; ?>" /></td>
                              </tr>
                            <tr>
                              <td height="24" class="texts"><strong>AD Url:</strong></td>
                              <td><input name="adpostingurl" type="text" class="form" id="adpostingurl" value="<?php echo $row_blogupdate['adpostingurl']; ?>" /></td>
                            </tr>
                            <tr>
                              <td height="24" class="texts"><strong>EDITIORS PICK:</strong></td>
                              <td><select name="editorpick" class="formmenu" id="editorpick">
                          ...
                          <input name="adpostingid" type="hidden" id="adpostingid" value="<?php echo $row_blogupdate['adpostingid']; ?>" />
