...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "pagesadd")) {
  $insertSQL = sprintf("INSERT INTO pages (name, title, `description`, metadesc, metakey, selecttopic, `position`) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "pagesupdate")) {
  $updateSQL = sprintf("UPDATE pages SET name=%s, title=%s, `description`=%s, metadesc=%s, metakey=%s, selecttopic=%s, `position`=%s WHERE pageid=%s",
                       GetSQLValueString($_POST['name'], "text"),
                       GetSQLValueString($_POST['title'], "text"),
                       GetSQLValueString($_POST['description'], "text"),
                       GetSQLValueString($_POST['metadesc'], "text"),
...
<title><?php echo $row_setting['title']; ?> - Pages</title>
			...
			if($row_contentlinks['status'] == 'active')
              ...
              <td width="700" height="30" align="center" valign="top"><?php if ($totalRows_pagesupdate == 0) { // Show if recordset empty ?>
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td background="images/leftNavBg.png" class="admintitle">PAGES</td>
                    </tr>
                  </table>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#ECCF5E">
                        <tr>
                          <td align="center" bgcolor="#FAF1D1" class="texts"><a href="pages.php" class="textsmallred">Back To Pages</a></td>
                        </tr>
                      </table>
                        <table width="40" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                        ...
                        <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                          <tr>
                            <td background="images/leftNavBg.png" class="admintitle">PAGES UPDATE</td>
                          </tr>
                        </table>
                        <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                          <tr>
                            <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="pagesupdate" id="pagesupdate">
                              <table width="100%" border="0" cellspacing="4" cellpadding="4">
                                <tr>
                                  <td width="99" class="texts"><strong>TITLE: *</strong></td>
                                  <td colspan="2"><input name="title" type="text" class="form" id="title" value="<?php echo $row_pagesupdate['title']; ?>" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>Menu Name: *</strong></td>
                                  <td><input name="name" type="text" class="form" id="name" value="<?php echo $row_pagesupdate['name']; ?>" /></td>
                                  <td class="textsmallred">NO SPACE PLEASE <strong>E.G : helpsupport</strong></td>
                                </tr>
                                <tr>
                                  <td valign="top" class="texts"><strong>DESCRIPTION: *</strong></td>
                                  <td colspan="2">
                                    <textarea name="description" cols="45" rows="5" class="wysiwyg" id="description"><?php echo $row_pagesupdate['description']; ?></textarea></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>METADESC:</strong></td>
                                  <td colspan="2"><input name="metadesc" type="text" class="form" id="metadesc" value="<?php echo $row_pagesupdate['metadesc']; ?>" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>METAKEY:</strong></td>
                                  <td colspan="2"><input name="metakey" type="text" class="form" id="metakey" value="<?php echo $row_pagesupdate['metakey']; ?>" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>POSITION:</strong></td>
                                  <td colspan="2"><select name="position" class="formmenu" id="position">
                                    <option value="leftmenu" <?php if (!(strcmp("leftmenu", $row_pagesupdate['position']))) {echo "selected=\"selected\"";} ?>>leftmenu</option>
                                    <option value="menu" <?php if (!(strcmp("menu", $row_pagesupdate['position']))) {echo "selected=\"selected\"";} ?>>menu</option>
                                    <option value="bottommenu" <?php if (!(strcmp("bottommenu", $row_pagesupdate['position']))) {echo "selected=\"selected\"";} ?>>bottommenu</option>
                                  </select></td>
                                </tr>
                                <tr>
                                  <td><input name="pageid" type="hidden" id="pageid" value="<?php echo $row_pagesupdate['pageid']; ?>" />
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("title","req","Please Enter Page Title");
  frmvalidator.addValidation("title","maxlen=30","Max length for Page Tile is 30");
  frmvalidator.addValidation("title","alphanumeric_space","Only AlphaNumeric Characters Allow");

  frmvalidator.addValidation("name","req","Please Enter Page name, no space please");
  frmvalidator.addValidation("name","maxlen=30","Max length for Name is 30");
  frmvalidator.addValidation("name","alpha","Only Alphabetic Characters Allow");
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
        <tr>
          <td background="images/leftNavBg.png" class="admintitle">NEW PAGE ADD</td>
          </tr>
        </table>
        <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="pagesadd" id="pagesadd">
              <table width="100%" border="0" cellspacing="4" cellpadding="4">
                <tr>
                  <td width="99" class="texts"><strong>TITLE:</strong> *</td>
                  <td colspan="2"><input name="title" type="text" class="form" id="title" /></td>
                  </tr>
                <tr>
                  <td class="texts"><strong>Menu Name: *</strong></td>
                  <td><input name="name" type="text" class="form" id="name" /></td>
                  <td><span class="textsmallred">NO SPACE PLEASE <strong>E.G : helpsupport</strong></span></td>
                  </tr>
                <tr>
                  <td valign="top" class="texts"><strong>DESCRIPTION: *</strong></td>
                  <td colspan="2">
                    <textarea name="description" cols="45" rows="5" class="wysiwyg" id="description"></textarea></td>
                  </tr>
                <tr>
                  <td class="texts"><strong>METADESC:</strong></td>
                  <td colspan="2"><input name="metadesc" type="text" class="form" id="metadesc" /></td>
                  </tr>
                <tr>
                  <td class="texts"><strong>METAKEY:</strong></td>
                  <td colspan="2"><input name="metakey" type="text" class="form" id="metakey" /></td>
                  </tr>
                <tr>
                  <td class="texts"><strong>POSITION:</strong></td>
                  <td colspan="2"><select name="position" class="formmenu" id="position">
                    ...
                    <option value="bottommenu">bottommenu</option>
                    </select></td>
                  </tr>
                <tr>
                  <td><input name="selecttopic" type="hidden" id="selecttopic" value="<?php echo $row_setting['selecttopic']; ?>" /></td>
                  <td width="82"><input name="button" type="submit" class="button" id="button" value="Add Page" /></td>
                  <td width="491">&nbsp;</td>
                  </tr>
                </table>
