...
$query_rsM = sprintf("SELECT * FROM media WHERE id = %s", GetSQLValueString($colname_rsM, "int"));
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_rsT = "SELECT * FROM media ORDER BY id DESC";
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogoverview = "SELECT * FROM media ORDER BY id DESC";
...
if (isset($_GET['id'])) {
  $colname_blogupdate = $_GET['id'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogupdate = sprintf("SELECT * FROM media WHERE id = %s", GetSQLValueString($colname_blogupdate, "int"));
...
<title><?php echo $row_setting['title']; ?>- Media</title>
...
<?php if($row_setting['selecttopic'] == 'custom')
			...
			if($row_contentlinks['status'] == 'active')
              ...
              <td width="700" height="30" align="center" valign="top"><?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td background="images/leftNavBg.png" class="admintitle">Media OVERVIEW</td>
                    </tr>
                  </table>
                    ...
                    <tr>
                      <td height="47" align="left" bgcolor="#FFFFFF"><?php if ($totalRows_blogoverview > 0) { // Show if recordset not empty ?>
                          <table width="100%" border="0" cellspacing="2" cellpadding="4">
                            ...
                            <?php do { ?>
                              <tr>
                                <td width="1" height="11" bgcolor="#FBFEFF" class="borderorangetable"><div class="texts"><img src="/images/media/<?php echo $row_blogoverview['imageurl']; ?>" height="50" width="50" /></div></td>
                                <td bgcolor="#FBFEFF"><input name="textfield" type="text" class="forms" id="textfield" value="/images/media/<?php echo $row_blogoverview['imageurl']; ?>" /></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="media.php?delete=<?php echo $row_blogoverview['id']; ?>" class="textsmallred" onClick="javascript:return confirm('Please Confirm Before Delete ?')">
                                  <div>Delete</div>
                              </a></td>
                              </tr>
  ...
  <?php } // Show if recordset empty ?></td>
                  ...
                  <?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                    <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <td background="images/leftNavBg.png" class="admintitle">ADD Image to media</td>
                      </tr>
                    </table>
                    <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="add" id="add">
                          <table width="100%" height="60" border="0" cellpadding="0" cellspacing="4">
                            <tr>
                              <td width="101" height="24" class="texts"><strong>IMAGE:*</strong></td>
                              <td width="728"><input name="imageurl" type="file" class="formmenusimple" id="imageurl" /></td>
                            </tr>
                            <tr>
                              <td height="24">&nbsp;</td>
