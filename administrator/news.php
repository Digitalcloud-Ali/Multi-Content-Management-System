...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "pagesadd")) {
  $insertSQL = sprintf("INSERT INTO news (title, `description`, selecttopic) VALUES (%s, %s, %s)",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "pagesupdate")) {
  $updateSQL = sprintf("UPDATE news SET title=%s, `description`=%s, selecttopic=%s WHERE newsid=%s",
                       GetSQLValueString($_POST['title'], "text"),
                       GetSQLValueString($_POST['description'], "text"),
                       GetSQLValueString($_POST['selecttopic'], "text"),
...
if ((isset($_GET['newsiddelete'])) && ($_GET['newsiddelete'] != "")) {
  $deleteSQL = sprintf("DELETE FROM news WHERE newsid=%s",
                       GetSQLValueString($_GET['newsiddelete'], "int"));
...
$colname_pagesoverview = "-1";
if (isset($_SERVER['selecttopic'])) {
  $colname_pagesoverview = $_SERVER['selecttopic'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_pagesoverview = sprintf("SELECT * FROM news WHERE selecttopic = %s ORDER BY newsid DESC", GetSQLValueString($colname_pagesoverview, "text"));
...
if (isset($_GET['newsid'])) {
  $colname_pagesupdate = $_GET['newsid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_pagesupdate = sprintf("SELECT * FROM news WHERE newsid = %s", GetSQLValueString($colname_pagesupdate, "int"));
...
<?php if($row_setting['selecttopic'] == 'custom')
			...
			if($row_contentlinks['status'] == 'active')
              ...
              <td width="700" height="30" align="center" valign="top"><?php if ($totalRows_pagesupdate == 0) { // Show if recordset empty ?>
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td background="images/leftNavBg.png" class="admintitle">NEWS</td>
                    </tr>
                  </table>
                    ...
                    <tr>
                      <td height="47" align="left" bgcolor="#FFFFFF"><?php if ($totalRows_pagesoverview > 0) { // Show if recordset not empty ?>
                          <table width="100%" border="0" cellspacing="2" cellpadding="4">
                            ...
                            <?php do { ?>
                              <tr>
                                <td height="11" align="center" class="smallbut"><div class="textsmallred"><?php echo $row_pagesoverview['newsid']; ?></div></td>
                                <td bgcolor="#FBFEFF" class="borderorangetable"><div class="texts"><?php echo $row_pagesoverview['title']; ?></div></td>
                                <td width="1" bgcolor="#FBFEFF" class="borderorangetable"><?php echo $row_pagesoverview['selecttopic']; ?></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="news.php?newsid=<?php echo $row_pagesoverview['newsid']; ?>" class="textsmallgreen">
                                  <div>Edit</div>
                                </a></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="news.php?newsiddelete=<?php echo $row_pagesoverview['newsid']; ?>" class="textsmallred" onClick="javascript:return confirm('Please Confirm Before Delete ?')">
                                  <div>Delete</div>
                                </a></td>
                              </tr>
  ...
  <table width="100%" border="0" cellspacing="2" cellpadding="4">
    <tr class="orangetitle">
      <td width="32" align="center">NO NEWS FOUNDED</td>
      </tr>
  </table>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#ECCF5E">
                        <tr>
                          <td align="center" bgcolor="#FAF1D1" class="texts"><a href="news.php" class="textsmallred">Back To News</a></td>
                        </tr>
                      </table>
                        <table width="40" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                        ...
                        <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                          <tr>
                            <td background="images/leftNavBg.png" class="admintitle">NEWS UPDATE</td>
                          </tr>
                        </table>
                        <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                          <tr>
                            <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="pagesupdate" id="pagesupdate">
                              <table width="100%" border="0" cellspacing="4" cellpadding="4">
                                ...
                                <tr>
                                  <td><input name="newsid" type="hidden" id="newsid" value="<?php echo $row_pagesupdate['newsid']; ?>" />
...
//You should create the validator only after the definition of the HTML form
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
        <tr>
          <td background="images/leftNavBg.png" class="admintitle">ADD NEWS</td>
          </tr>
        </table>
        <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="pagesadd" id="pagesadd">
              <table width="100%" border="0" cellspacing="4" cellpadding="4">
                ...
                <tr>
                  ...
                  <td width="82"><input name="button" type="submit" class="button" id="button" value="Publish" /></td>
                  <td width="491">&nbsp;</td>
                </tr>
                </table>
  ...
  frmvalidator.addValidation("title","req","Please Enter Page Title");
  frmvalidator.addValidation("title","maxlen=100","Max length for Page Tile is 100");
  frmvalidator.addValidation("title","alphanumeric_space","Only AlphaNumeric Characters Allow");
