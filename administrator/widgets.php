...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "add")) {
  $insertSQL = sprintf("INSERT INTO widgets (widget, content, `position`, status) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['widget'], "text"),
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "update")) {
  $updateSQL = sprintf("UPDATE widgets SET widget=%s, content=%s, `position`=%s, status=%s WHERE wid=%s",
                       GetSQLValueString($_POST['widget'], "text"),
                       GetSQLValueString($_POST['content'], "text"),
                       GetSQLValueString($_POST['position'], "text"),
                       GetSQLValueString($_POST['status'], "text"),
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogoverview = "SELECT * FROM widgets ORDER BY wid DESC";
...
if (isset($_GET['wid'])) {
  $colname_blogupdate = $_GET['wid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogupdate = sprintf("SELECT * FROM widgets WHERE wid = %s", GetSQLValueString($colname_blogupdate, "int"));
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_categorylist = "SELECT * FROM categories WHERE selecttopic = 'doctors'";
...
<title><?php echo $row_setting['title']; ?> - Widgets</title>
...
<?php if($row_setting['selecttopic'] == 'custom')
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="leftmenu">
                  <tr>
                    <td height="35"><a href="portfolio.php">
                      <div style="line-height:37px;"><img src="images/user2.png" alt="Portfolio or Resume" width="14" height="14" border="0" style="padding-left:9px;padding-right:7px;" /> Doctors / Resume
                      </div>
                      </a></td>
                    </tr>
                  </table>
			...
			if($row_contentlinks['status'] == 'active')
              ...
              <td width="700" height="30" align="center" valign="top"><?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td background="images/leftNavBg.png" class="admintitle">WIDGETS OVERVIEW</td>
                    </tr>
                  </table>
                    ...
                    <tr>
                      <td height="47" align="left" bgcolor="#FFFFFF"><?php if ($totalRows_blogoverview > 0) { // Show if recordset not empty ?>
                          <table width="100%" border="0" cellspacing="2" cellpadding="4">
                            ...
                            <?php do { ?>
                              <tr>
                                <td height="11" align="center" class="smallbut"><div class="textsmallred"><?php echo $row_blogoverview['wid']; ?></div></td>
                                <td bgcolor="#FBFEFF" class="borderorangetable"><div class="texts"><?php echo $row_blogoverview['widget']; ?></div></td>
                                <td width="1" bgcolor="#FBFEFF" class="borderorangetable"><?php echo $row_blogoverview['position']; ?></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="widgets.php?wid=<?php echo $row_blogoverview['wid']; ?>" class="textsmallgreen">
                                  <div>Edit</div>
                                </a></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="widgets.php?delete=<?php echo $row_blogoverview['wid']; ?>" class="textsmallred" onClick="javascript:return confirm('Please Confirm Before Delete ?')">
                                  <div>Delete</div>
                                </a></td>
                              </tr>
  ...
  <table width="100%" border="0" cellspacing="2" cellpadding="4">
    <tr class="orangetitle">
      <td width="32" align="center">NO WIDGETS FOUNDED</td>
      </tr>
  </table>
  <?php } // Show if recordset empty ?></td>
                  ...
                  <?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                    <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <td background="images/leftNavBg.png" class="admintitle">ADD WIDGET</td>
                      </tr>
                    </table>
                    <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="add" id="add">
                          <table width="100%" height="113" border="0" cellpadding="0" cellspacing="4">
                            <tr>
                              <td width="101" height="22" class="texts"><strong>TITLE:*</strong></td>
                              <td width="728"><input name="widget" type="text" class="form" id="widget" /></td>
                            </tr>
                            <tr>
                              <td height="23" valign="top" class="texts"><strong>DESCRIPTION:*</strong></td>
                              <td><textarea name="content" cols="55" rows="5" class="formtextarea" id="content"></textarea></td>
                            </tr>
                            <tr>
                              <td height="24" class="texts"><strong>POSITION:</strong></td>
                              <td><select name="position" class="formmenu" id="position">
                            ...
                            <tr>
                              <td height="24"><input name="status" type="hidden" id="status" value="active" /></td>
  ...
  frmvalidator.addValidation("widget","req","Please Enter Widget Name");
  frmvalidator.addValidation("widget","maxlen=500","Max length for Widget Name is 500");
    	
  frmvalidator.addValidation("content","req","Please Enter content");
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#ECCF5E">
    <tr>
      <td align="center" bgcolor="#FAF1D1" class="texts"><a href="widgets.php" class="textsmallred">Back To Widgets</a></td>
    </tr>
  </table>
  <table width="40" border="0" cellpadding="0" cellspacing="0">
    <tr>
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
      <td background="images/leftNavBg.png" class="admintitle">UPDATE WIDGET</td>
      </tr>
  </table>
                    <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="update" id="update">
                          <table width="100%" height="113" border="0" cellpadding="0" cellspacing="4">
                            <tr>
                              <td width="101" height="22" class="texts"><strong>TITLE:</strong>*</td>
                              <td width="728"><input name="widget" type="text" class="form" id="widget" value="<?php echo $row_blogupdate['widget']; ?>" /></td>
                              </tr>
                            <tr>
                              <td height="23" valign="top" class="texts"><strong>DESCRIPTION:*</strong></td>
                              <td><textarea name="content" cols="55" rows="5" class="formtextarea" id="content"><?php echo $row_blogupdate['content']; ?></textarea></td>
                            </tr>
                            <tr>
                              <td height="24" class="texts"><strong>POSITION:</strong></td>
                              <td><select name="position" class="formmenu" id="position">
                                <option value="none" <?php if (!(strcmp("none", $row_blogupdate['position']))) {echo "selected=\"selected\"";} ?>>none</option>
                                <option value="home" <?php if (!(strcmp("home", $row_blogupdate['position']))) {echo "selected=\"selected\"";} ?>>home</option>
                                <option value="contact" <?php if (!(strcmp("contact", $row_blogupdate['position']))) {echo "selected=\"selected\"";} ?>>contact</option>
                                <option value="content" <?php if (!(strcmp("content", $row_blogupdate['position']))) {echo "selected=\"selected\"";} ?>>content</option>
                                <option value="news" <?php if (!(strcmp("news", $row_blogupdate['position']))) {echo "selected=\"selected\"";} ?>>news</option>
                                <option value="sidemenu" <?php if (!(strcmp("sidemenu", $row_blogupdate['position']))) {echo "selected=\"selected\"";} ?>>sidemenu</option>
                              </select></td>
                            </tr>
                            <tr>
                              <td height="24"><input name="status" type="hidden" id="status" value="<?php echo $row_blogupdate['status']; ?>" /></td>
                              <td><input name="button" type="submit" class="button" id="button" value="Update" /></td>
                            </tr>
                            </table>
                          <input name="wid" type="hidden" id="wid" value="<?php echo $row_blogupdate['wid']; ?>" />
