...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogoverview = "SELECT * FROM blog ORDER BY blogid DESC";
...
if (isset($_GET['blogid'])) {
  $colname_blogupdate = $_GET['blogid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogupdate = sprintf("SELECT * FROM blog WHERE blogid = %s", GetSQLValueString($colname_blogupdate, "int"));
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_categorylist = "SELECT * FROM categories WHERE selecttopic = 'blog'";
...
<title><?php echo $row_setting['title']; ?> - Blog</title>
...
<?php if($row_setting['selecttopic'] == 'custom')
			...
			if($row_contentlinks['status'] == 'active')
              ...
              <td width="700" height="30" align="center" valign="top"><?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td background="images/leftNavBg.png" class="admintitle">NEWS / BLOG OVERVIEW</td>
                    </tr>
                  </table>
  ...
  <table width="100%" border="0" cellspacing="2" cellpadding="4">
    ...
    <?php do { ?>
      <tr>
        <td height="11" align="center" class="smallbut"><div class="textsmallred"><?php echo $row_blogoverview['blogid']; ?></div></td>
        <td bgcolor="#FBFEFF" class="borderorangetable"><div class="texts"><?php echo $row_blogoverview['title']; ?></div></td>
        <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="blog.php?blogid=<?php echo $row_blogoverview['blogid']; ?>" class="textsmallgreen">
          <div>Edit</div>
        </a></td>
        <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="blog.php?delete=<?php echo $row_blogoverview['blogid']; ?>" class="textsmallred" onClick="javascript:return confirm('Please Confirm Before Delete ?')">
          <div>Delete</div>
        </a></td>
      </tr>
...
?>
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#ECCF5E">
    <tr>
      <td align="center" bgcolor="#FAF1D1" class="texts"><a href="blog.php" class="textsmallred">Back To Blog</a></td>
    </tr>
  </table>
  <table width="40" border="0" cellpadding="0" cellspacing="0">
    <tr>
...
?>
                            ...
                            <tr>
                              <td height="24" class="texts"><strong>MEAT DESC:*</strong></td>
                              <td><input name="metadesc" type="text" class="form" id="metadesc" value="<?php echo $row_blogupdate['metadesc']; ?>" /></td>
                              </tr>
                            <tr>
                              <td height="24" class="texts"><strong>META KEY:*</strong></td>
                              <td><input name="metakey" type="text" class="form" id="metakey" value="<?php echo $row_blogupdate['metakey']; ?>" /></td>
                              </tr>
                            <tr>
                              <td height="24" class="texts"><strong>POSITION:</strong></td>
                              <td>
                          ...
                          <input name="blogid" type="hidden" id="blogid" value="<?php echo $row_blogupdate['blogid']; ?>" />
