...
$colname_rsM = "-1";
if (isset($_GET['doctorsid'])) {
  $colname_rsM = $_GET['doctorsid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_rsM = sprintf("SELECT * FROM doctors WHERE doctorsid = %s", GetSQLValueString($colname_rsM, "int"));
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_rsT = "SELECT * FROM doctors ORDER BY doctorsid DESC";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "add")) {
   ...
   // UPLOAD CODE BY SYED RAZA ALI START //
  	...
  	$no_ID = $row_rsT['doctorsid'];
	$max_filesize = 5250000;
  	$upload_path = '../doctors/images/data/';
  ...
  $insertSQL = sprintf("INSERT INTO doctors (title, `description`, author, dates, image, status, `position`, users, rating, views, selecttopic) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $Result1 = mysqli_query(dbconnect(),$insertSQL) or die(mysqli_connect_error());
    ...
    $insertSQL = sprintf("INSERT INTO doctors (title, dates, users, selecttopic) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['title'], "text"),
                       GetSQLValueString($_POST['dates'], "text"),
                       GetSQLValueString($_POST['users'], "text"),
                       GetSQLValueString($_POST['selecttopic'], "text"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "update")) {
  ...
  $updateSQL = sprintf("UPDATE doctors SET title=%s, `description`=%s, author=%s, dates=%s, image=%s, status=%s, `position`=%s, users=%s, rating=%s, views=%s, selecttopic=%s WHERE doctorsid=%s",
                       GetSQLValueString($_POST['title'], "text"),
                       GetSQLValueString($_POST['description'], "text"),
                       GetSQLValueString($_POST['author'], "text"),
                       GetSQLValueString($_POST['dates'], "text"),
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogoverview = "SELECT * FROM doctors ORDER BY doctorsid DESC";
...
if (isset($_GET['doctorsid'])) {
  $colname_blogupdate = $_GET['doctorsid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogupdate = sprintf("SELECT * FROM doctors WHERE doctorsid = %s", GetSQLValueString($colname_blogupdate, "int"));
...
<title><?php echo $row_setting['title']; ?> - Doctors</title>
...
<?php if($row_setting['selecttopic'] == 'custom')
			...
			if($row_contentlinks['status'] == 'active')
              ...
              <td width="700" height="30" align="center" valign="top"><?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td background="images/leftNavBg.png" class="admintitle">DOCTOR OVERVIEW</td>
                    </tr>
                  </table>
                    ...
                    <tr>
                      <td height="47" align="left" bgcolor="#FFFFFF"><?php if ($totalRows_blogoverview > 0) { // Show if recordset not empty ?>
                          <table width="100%" border="0" cellspacing="2" cellpadding="4">
                            ...
                            <?php do { ?>
                              <tr>
                                <td height="11" align="center" class="smallbut"><div class="textsmallred"><?php echo $row_blogoverview['doctorsid']; ?></div></td>
                                <td bgcolor="#FBFEFF" class="borderorangetable"><div class="texts"><?php echo $row_blogoverview['title']; ?></div></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="doctors.php?doctorsid=<?php echo $row_blogoverview['doctorsid']; ?>" class="textsmallgreen">
                                  <div>Edit</div>
                                </a></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="doctors.php?delete=<?php echo $row_blogoverview['doctorsid']; ?>" class="textsmallred" onClick="javascript:return confirm('Please Confirm Before Delete ?')">
                                  <div>Delete</div>
                                </a></td>
                              </tr>
  ...
  <table width="100%" border="0" cellspacing="2" cellpadding="4">
    <tr class="orangetitle">
      <td width="32" align="center">NO Doctors FOUNDED</td>
      </tr>
  </table>
  <?php } // Show if recordset empty ?></td>
                  ...
                  <?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                    <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <td background="images/leftNavBg.png" class="admintitle">ADD DOCTOR DATA</td>
                      </tr>
                    </table>
                    <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="add" id="add">
                          ...
                          <input name="selecttopic" type="hidden" id="selecttopic" value="doctors" />
<input type="hidden" name="MM_insert" value="add" />
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#ECCF5E">
    <tr>
      <td align="center" bgcolor="#FAF1D1" class="texts"><a href="doctors.php" class="textsmallred">Back To Doctors</a></td>
    </tr>
  </table>
  <table width="40" border="0" cellpadding="0" cellspacing="0">
    <tr>
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
      <td background="images/leftNavBg.png" class="admintitle">UPDATE DOCTOR DATE</td>
      </tr>
  </table>
                    <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="update" id="update">
                          <table width="100%" height="197" border="0" cellpadding="0" cellspacing="4">
                            ...
                            <tr>
                              <td height="24" class="texts"><strong>DATE:*</strong></td>
                              <td><input name="dates" type="text" class="form" id="dates" value="<?php echo $row_blogupdate['dates']; ?>" /></td>
                              </tr>
                            <tr>
                              <td height="24" class="texts"><strong>IMAGE:</strong></td>
                              <td><input name="image" type="file" class="formmenusimple" id="image" /><?php echo $row_blogupdate['image']; ?></td>
                            </tr>
                            <tr>
                              <td height="24" class="texts"><strong>POSITION:</strong></td>
                              <td>
...
<input name="doctorsid" type="hidden" id="doctorsid" value="<?php echo $row_blogupdate['doctorsid']; ?>" />
