...
if (isset($_GET['memberid'])) {
  $colname_membersupdate = $_GET['memberid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_membersupdate = sprintf("SELECT * FROM members WHERE memberid = %s", GetSQLValueString($colname_membersupdate, "int"));
...
<title><?php echo $row_setting['title']; ?> - Members</title>
...
<?php if($row_setting['selecttopic'] == 'custom')
			...
			if($row_contentlinks['status'] == 'active')
			  ...
			  ?></td>
              <td width="13">&nbsp;</td>
              <td width="700" height="30" align="center" valign="top"><?php if ($totalRows_membersupdate == 0) { // Show if recordset empty ?>
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td background="images/leftNavBg.png" class="admintitle">MEMBERS</td>
                    </tr>
                  </table>
                  <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td height="47" align="left" bgcolor="#FFFFFF"><?php if ($totalRows_membersoverview > 0) { // Show if recordset not empty ?>
  <table width="100%" border="0" cellspacing="2" cellpadding="4">
    ...
    <?php do { ?>
      <tr>
        <td height="11" align="center" class="smallbut"><div class="textsmallred"><?php echo $row_membersoverview['memberid']; ?></div></td>
        <td bgcolor="#FBFEFF" class="borderorangetable"><div class="texts"><?php echo $row_membersoverview['users']; ?></div></td>
        <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="members.php?memberid=<?php echo $row_membersoverview['memberid']; ?>" class="textsmallgreen">
          <div>Edit</div>
        </a></td>
        <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="members.php?memberiddelete=<?php echo $row_membersoverview['memberid']; ?>" class="textsmallred" onClick="javascript:return confirm('Please Confirm Before Delete ? Warning: All content posted by this member will be deleted as well....')">
          <div>Delete</div>
        </a></td>
      </tr>
      <?php } while ($row_membersoverview = mysqli_fetch_assoc($membersoverview)); ?>
  </table>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><table width="40" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td align="center" class="pagesmove"><a href="<?php printf("%s?pageNum_membersoverview=%d%s", $currentPage, 0, $queryString_membersoverview); ?>">&lt;</a></td>
          <td align="center" class="pagesmove"><a href="<?php printf("%s?pageNum_membersoverview=%d%s", $currentPage, max(0, $pageNum_membersoverview - 1), $queryString_membersoverview); ?>">&lt;&lt;</a></td>
          <td align="center" class="pagesmove"><a href="<?php printf("%s?pageNum_membersoverview=%d%s", $currentPage, min($totalPages_membersoverview, $pageNum_membersoverview + 1), $queryString_membersoverview); ?>">&gt;&gt;</a></td>
          <td align="center" class="pagesmove"><a href="<?php printf("%s?pageNum_membersoverview=%d%s", $currentPage, $totalPages_membersoverview, $queryString_membersoverview); ?>">&gt;</a></td>
        </tr>
      </table></td>
    </tr>
  </table>
  <?php } // Show if recordset not empty ?>
                        <?php if ($totalRows_membersoverview == 0) { // Show if recordset empty ?>
                          <table width="100%" border="0" cellspacing="2" cellpadding="4">
                            <tr class="orangetitle">
                              <td align="center">NO MEMBERS FOUNDED</td>
                            </tr>
                          </table>
                ...
                <?php if ($totalRows_membersupdate > 0) { // Show if recordset not empty ?>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#ECCF5E">
                        <tr>
                          <td align="center" bgcolor="#FAF1D1" class="texts"><a href="members.php" class="textsmallred">Back To Members</a></td>
                        </tr>
                      </table>
                        <table width="40" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                        ...
                        <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                          <tr>
                          <td background="images/leftNavBg.png" class="admintitle">MEMBER UPDATE</td>
                        </tr>
                    </table>
                        <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                          <tr>
                            <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="memberupdate" id="memberupdate">
                              <table width="100%" border="0" cellspacing="4" cellpadding="4">
                                ...
                                <tr>
                                  <td class="texts"><strong>LEVEL:*</strong></td>
                                  <td colspan="2"><select name="level" class="formmenu" id="level">
                                      <option value="administrator" <?php if (!(strcmp("administrator", $row_membersupdate['level']))) {echo "selected=\"selected\"";} ?>>Administrator</option>
                                      <option value="editor" <?php if (!(strcmp("editor", $row_membersupdate['level']))) {echo "selected=\"selected\"";} ?>>Editor</option>
                                      <option value="member" <?php if (!(strcmp("member", $row_membersupdate['level']))) {echo "selected=\"selected\"";} ?>>Member</option>
                                    </select></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td class="texts"><strong>STATUS:</strong></td>
                                  <td colspan="2">
                                    <select name="status" class="formmenu" id="status">
                                      <option value="active" <?php if (!(strcmp("active", $row_membersupdate['status']))) {echo "selected=\"selected\"";} ?>>active</option>
                                      <option value="pending" <?php if (!(strcmp("pending", $row_membersupdate['status']))) {echo "selected=\"selected\"";} ?>>pending</option>
                                    </select></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>POSITION:</strong></td>
                                  <td colspan="2"><select name="position" class="formmenu" id="position">
                                    <option value="basic" <?php if (!(strcmp("basic", $row_membersupdate['position']))) {echo "selected=\"selected\"";} ?>>basic</option>
                                    <option value="bronze" <?php if (!(strcmp("bronze", $row_membersupdate['position']))) {echo "selected=\"selected\"";} ?>>bronze</option>
                                    <option value="gold" <?php if (!(strcmp("gold", $row_membersupdate['position']))) {echo "selected=\"selected\"";} ?>>gold</option>
                                  </select></td>
                                </tr>
                                <tr>
                                  <td><input name="memberid" type="hidden" id="memberid" value="<?php echo $row_membersupdate['memberid']; ?>" /></td>
  ...
  frmvalidator.addValidation("users","alphanumeric","Only AlphaNumeric Characters Allow and No Space Please");
  ...
  frmvalidator.addValidation("fullname","alphanumeric","Only AlphaNumeric Characters Allow and No Space Please");
  ...
  frmvalidator.addValidation("country","alphanumeric_space","Only AlphaNumeric Characters Allow");
      ...
      value="<?php echo $row_membersupdate['memberid']; ?>" /></td>
                  ...
                  <?php } // Show if recordset not empty ?>
                <?php if ($totalRows_membersupdate == 0) { // Show if recordset empty ?>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                        <tr>
                          <td background="images/leftNavBg.png" class="admintitle">ADD NEW MEMBER</td>
                        </tr>
                      </table>
                        <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                          <tr>
                            <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="memberinsert" id="memberinsert">
                              <table width="100%" border="0" cellspacing="4" cellpadding="4">
                                <tr>
                                  <td width="69" class="texts"><strong>USER:*</strong></td>
                                  <td colspan="2"><input name="users" type="text" class="form" id="users" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>PASS:*</strong></td>
                                  <td colspan="2"><input name="passs" type="text" class="form" id="passs" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>LEVEL:*</strong></td>
                                  <td colspan="2"><select name="level" class="formmenu" id="level">
                                ...
                                <tr>
                                  <td class="texts"><strong>FULLNAME:*</strong></td>
                                  <td colspan="2"><input name="fullname" type="text" class="form" id="fullname" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>ADDRESS:*</strong></td>
                                  <td colspan="2"><input name="address" type="text" class="form" id="address" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>EMAIL:*</strong></td>
                                  <td colspan="2"><input name="email" type="text" class="form" id="email" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>PHOTO:*</strong></td>
                                  <td colspan="2"><input name="photo" type="file" class="formmenusimple" id="photo" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>ZIP:*</strong></td>
                                  <td colspan="2"><input name="zip" type="text" class="form" id="zip" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>CITY:*</strong></td>
                                  <td colspan="2"><input name="city" type="text" class="form" id="city" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>STATE:*</strong></td>
                                  <td colspan="2"><input name="state" type="text" class="form" id="state" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>COUNTRY:*</strong></td>
                                  <td colspan="2"><input name="country" type="text" class="form" id="country" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>PHONE:*</strong></td>
                                  <td colspan="2"><input name="phone" type="text" class="form" id="phone" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>YAHOOID:</strong></td>
                                  <td colspan="2"><input name="yahooid" type="text" class="form" id="yahooid" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>TWITTER:</strong></td>
                                  <td colspan="2"><input name="twitter" type="text" class="form" id="twitter" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>FACEBOOK:</strong></td>
                                  <td colspan="2"><input name="facebook" type="text" class="form" id="facebook" /></td>
                                </tr>
                                <tr>
                                  <td class="texts"><strong>STATUS:</strong></td>
                                  <td colspan="2">
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td width="82"><input name="button" type="submit" class="button" id="button" value="Add User" /></td>
                                  <td width="491">&nbsp;</td>
                                </tr>
                              </table>
                              <input type="hidden" name="MM_insert" value="memberinsert" />
                            </form>
                            <script language="JavaScript" type="text/javascript">

  var frmvalidator  = new Validator("memberinsert");
  frmvalidator.addValidation("users","req","Please Enter Username");
  frmvalidator.addValidation("users","maxlen=20","Max length for Username is 20");
  frmvalidator.addValidation("users","alphanumeric","Only AlphaNumeric Characters Allow and No Space Please");
