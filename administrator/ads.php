...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "pagesupdate")) {
  $updateSQL = sprintf("UPDATE settings SET ad1=%s, ad2=%s, ad3=%s, ad4=%s, ad5=%s, ad6=%s WHERE settingid=%s",
                       ...
                       GetSQLValueString($_POST['ad5'], "text"),
                       GetSQLValueString($_POST['ad6'], "text"),
...
<title><?php echo $row_setting['title']; ?> - Ads</title>
...
<?php if($row_setting['selecttopic'] == 'custom')
			...
			if($row_contentlinks['status'] == 'active')
              ...
              <td width="700" height="30" align="center" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                <tr>
                    <td background="images/leftNavBg.png" class="admintitle">ADS MANAGEMENT</td>
                  </tr>
            </table>
                  ...
                  <tr>
                    <td height="47" align="left" bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="pagesupdate" id="pagesupdate">
                      <table width="100%" border="0" cellspacing="4" cellpadding="4">
                        <tr>
                          <td width="69" valign="top" class="texts"><strong>AD 1:</strong></td>
                          <td colspan="2" class="texts"><textarea name="ad1" cols="2" rows="6" class="formtextarea" id="ad1"><?php echo $row_setting['ad1']; ?></textarea>
                            <strong>CODE:</strong> <?php echo $row_setting['ad1']; ?></td>
                        </tr>
                        <tr>
                          <td valign="top" class="texts"><strong>AD 2:</strong></td>
                          <td colspan="2" class="texts">
                            <textarea name="ad2" cols="2" rows="6" class="formtextarea" id="ad2"><?php echo $row_setting['ad2']; ?></textarea>
                            <strong>CODE : </strong><?php echo $row_setting['ad2']; ?></td>
                        </tr>
                        <tr>
                          <td valign="top" class="texts"><strong>AD 3:</strong></td>
                          <td colspan="2" class="texts">
                            <textarea name="ad3" cols="2" rows="6" class="formtextarea" id="linktitle3"><?php echo $row_setting['ad3']; ?></textarea>
                            <strong>CODE :</strong> <?php echo $row_setting['ad3']; ?></td>
                        </tr>
                        <tr>
                          <td valign="top" class="texts"><strong>AD 4:</strong></td>
                          <td colspan="2" class="texts">
                            <textarea name="ad4" cols="2" rows="6" class="formtextarea" id="linktitle4"><?php echo $row_setting['ad4']; ?></textarea>
                            <strong>CODE :</strong> <?php echo $row_setting['ad4']; ?></td>
                        </tr>
                        <tr>
                          <td valign="top" class="texts"><strong>AD 5:</strong></td>
                          <td colspan="2" class="texts"><strong>
                            <textarea name="ad5" cols="2" rows="6" class="formtextarea" id="linktitle5"><?php echo $row_setting['ad5']; ?></textarea>
                            CODE : </strong><?php echo $row_setting['ad5']; ?></td>
                        </tr>
                        <tr>
                          <td valign="top" class="texts"><strong>AD 6:</strong></td>
                          <td colspan="2" class="texts">
                            <textarea name="ad6" cols="2" rows="6" class="formtextarea" id="linktitle6"><?php echo $row_setting['ad6']; ?></textarea>
                            <strong>CODE :</strong> <?php echo $row_setting['ad6']; ?></td>
                        </tr>
                        <tr>
