...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "add")) {
   ...
   // UPLOAD CODE BY SYED RAZA ALI START //
  	...
  	$no_ID = $row_rsT['tutorialsid'];
	$max_filesize = 5250000;
  	$upload_path = '../tutorials/images/tutorials/';
  ...
  $insertSQL = sprintf("INSERT INTO tutorials (title, `description`, imageurl, owner, `date`, catename, tutorialsurl, tutorialpathurl, status, rating, views, `position`, users, editorpick) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $Result1 = mysqli_query(dbconnect(),$insertSQL) or die(mysqli_connect_error());
    ...
    $insertSQL = sprintf("INSERT INTO tutorials (title, `date`, catename, users, selecttopic) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['title'], "text"),
                       GetSQLValueString($_POST['date'], "text"),
                       GetSQLValueString($_POST['catename'], "text"),
                       GetSQLValueString($_POST['users'], "text"),
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "update")) {
  ...
  $updateSQL = sprintf("UPDATE tutorials SET title=%s, `description`=%s, imageurl=%s, `date`=%s, catename=%s, tutorialsurl=%s, tutorialpathurl=%s, status=%s, rating=%s, views=%s, `position`=%s, users=%s, editorpick=%s WHERE tutorialsid=%s",
                       GetSQLValueString($_POST['title'], "text"),
                       GetSQLValueString($_POST['description'], "text"),
                       GetSQLValueString($filename, "text"),
                       GetSQLValueString($_POST['date'], "text"),
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogoverview = "SELECT * FROM tutorials ORDER BY tutorialsid DESC";
...
if (isset($_GET['tutorialsid'])) {
  $colname_blogupdate = $_GET['tutorialsid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogupdate = sprintf("SELECT * FROM tutorials WHERE tutorialsid = %s", GetSQLValueString($colname_blogupdate, "int"));
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_categorylist = "SELECT * FROM categories WHERE selecttopic = 'tutorials'";
...
<title><?php echo $row_setting['title']; ?> - Tutorials</title>
...
<?php if($row_setting['selecttopic'] == 'custom')
			...
			if($row_contentlinks['status'] == 'active')
              ...
              <td width="700" height="30" align="center" valign="top"><?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td background="images/leftNavBg.png" class="admintitle">Tutorials OVERVIEW</td>
                      </tr>
                  </table>
                    ...
                    <tr>
                      <td height="47" align="left" bgcolor="#FFFFFF"><?php if ($totalRows_blogoverview > 0) { // Show if recordset not empty ?>
                          <table width="100%" border="0" cellspacing="2" cellpadding="4">
                            ...
                            <?php do { ?>
                              <tr>
                                <td height="11" align="center" class="smallbut"><div class="textsmallred"><?php echo $row_blogoverview['tutorialsid']; ?></div></td>
                                <td bgcolor="#FBFEFF" class="borderorangetable"><div class="texts"><?php echo $row_blogoverview['title']; ?></div></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="tutorials.php?tutorialsid=<?php echo $row_blogoverview['tutorialsid']; ?>" class="textsmallgreen">
                                  <div>Edit</div>
                                </a></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="tutorials.php?delete=<?php echo $row_blogoverview['tutorialsid']; ?>" class="textsmallred" onClick="javascript:return confirm('Please Confirm Before Delete ?')">
                                  <div>Delete</div>
                                </a></td>
                              </tr>
                        ...
                        <?php if ($totalRows_blogoverview == 0) { // Show if recordset empty ?>
                          <table width="100%" border="0" cellspacing="2" cellpadding="4">
                            <tr class="orangetitle">
                              <td width="32" align="center">NO Tutorial FOUNDED</td>
                              </tr>
                          </table>
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
      <td background="images/leftNavBg.png" class="admintitle">ADD Tutorial</td>
      </tr>
  </table>
                  <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
...
?>
                          ...
                          <tr>
                            ...
                            <td><input name="tutorialsurl" type="text" class="form" id="tutorialsurl" /></td>
                          </tr>
                          <tr>
                            <td height="24" class="texts"><strong>TUTORIAL URL:*</strong></td>
                            <td><input name="tutorialpathurl" type="text" class="form" id="tutorialpathurl" /></td>
                          </tr>
                          <tr>
                        ...
                        <input name="selecttopic" type="hidden" id="selecttopic" value="tutorials" />
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#ECCF5E">
    <tr>
      <td align="center" bgcolor="#FAF1D1" class="texts"><a href="tutorials.php" class="textsmallred">Back To Tutorials</a></td>
      </tr>
  </table>
                  <table width="40" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                  ...
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td background="images/leftNavBg.png" class="admintitle">UPDATE Tutorial</td>
                      </tr>
                  </table>
                  <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
...
?>
                          ...
                          <tr>
                            ...
                            <td><input name="imageurl" type="file" class="formmenusimple" id="imageurl" />
                              <?php echo $row_blogupdate['imageurl']; ?></td>
                          </tr>
                          <tr>
                            <td height="24" class="texts"><strong>WEBSITE URL:*</strong></td>
                            <td><input name="tutorialsurl" type="text" class="form" id="tutorialsurl" value="<?php echo $row_blogupdate['tutorialsurl']; ?>" /></td>
                          </tr>
                          <tr>
                            <td height="24" class="texts"><strong>TUTORIAL URL:*</strong></td>
                            <td><input name="tutorialpathurl" type="text" class="form" id="tutorialpathurl" value="<?php echo $row_blogupdate['tutorialpathurl']; ?>" /></td>
                          </tr>
                          <tr>
                            <td height="24" class="texts"><strong>EDITIORS PICK:</strong></td>
                            <td><select name="editorpick" class="formmenu" id="editorpick">
                        ...
                        <input name="tutorialsid" type="hidden" id="tutorialsid" value="<?php echo $row_blogupdate['tutorialsid']; ?>" />
