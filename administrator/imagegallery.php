...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "add")) {
   ...
   // UPLOAD CODE BY SYED RAZA ALI START //
  	...
  	$no_ID = $row_rsT['imageid'];
	$max_filesize = 5250000;
  	$upload_path = '../imagegallery/images/gallery/';
  ...
  $insertSQL = sprintf("INSERT INTO image (title, `description`, imageurl, `date`, catename, status, rating, views, `position`, users) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $Result1 = mysqli_query(dbconnect(),$insertSQL) or die(mysqli_connect_error());
    ...
    $insertSQL = sprintf("INSERT INTO image (title, `date`, catename, users, selecttopic) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['title'], "text"),
                       GetSQLValueString($_POST['date'], "text"),
                       GetSQLValueString($_POST['catename'], "text"),
                       GetSQLValueString($_POST['users'], "text"),
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogoverview = "SELECT * FROM image ORDER BY imageid DESC";
...
if (isset($_GET['imageid'])) {
  $colname_blogupdate = $_GET['imageid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_blogupdate = sprintf("SELECT * FROM image WHERE imageid = %s", GetSQLValueString($colname_blogupdate, "int"));
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_categorylist = "SELECT * FROM categories WHERE selecttopic = 'imagegallery'";
...
<title><?php echo $row_setting['title']; ?> - Image Gallery</title>
...
<?php if($row_setting['selecttopic'] == 'custom')
			...
			if($row_contentlinks['status'] == 'active')
              ...
              <td width="700" height="30" align="center" valign="top"><?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                      <td background="images/leftNavBg.png" class="admintitle">ImageGallery OVERVIEW</td>
                    </tr>
                  </table>
                      ...
                      <td height="47" align="left" bgcolor="#FFFFFF"><?php if ($totalRows_blogoverview > 0) { // Show if recordset not empty ?>
                          <table width="100%" border="0" cellspacing="2" cellpadding="4">
                            <tr class="orangetitle" style="background-image:url(images/spinner-bg.gif);">
                              ...
                              <td colspan="4">CATENAME</td>
                            </tr>
                            <?php do { ?>
                              <tr>
                                <td height="11" align="center" class="smallbut"><div class="textsmallred"><?php echo $row_blogoverview['imageid']; ?></div></td>
                                <td width="1" bgcolor="#FBFEFF" class="borderorangetable"><img src="../imagegallery/images/gallery/<?php echo $row_blogoverview['imageurl']; ?>" width="30" height="30" /></td>
                                <td bgcolor="#FBFEFF" class="borderorangetable"><div class="texts"><?php echo $row_blogoverview['title']; ?></div></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="imagegallery.php?imageid=<?php echo $row_blogoverview['imageid']; ?>" class="textsmallgreen">
                                  <div>Edit</div>
                                </a></td>
                                <td width="1" align="center" bgcolor="#FBFEFF" class="borderorangetable"><a href="imagegallery.php?delete=<?php echo $row_blogoverview['imageid']; ?>" class="textsmallred" onClick="javascript:return confirm('Please Confirm Before Delete ?')">
                                  <div>Delete</div>
                                </a></td>
                              </tr>
  ...
  <table width="100%" border="0" cellspacing="2" cellpadding="4">
    <tr class="orangetitle">
      <td width="32" align="center">NO IMAGE FOUNDED</td>
      </tr>
  </table>
  <?php } // Show if recordset empty ?></td>
                  ...
                  <?php if ($totalRows_blogupdate == 0) { // Show if recordset empty ?>
                    <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <td background="images/leftNavBg.png" class="admintitle">ADD Image</td>
                      </tr>
                    </table>
                    <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
...
?>
                          ...
                          <input name="selecttopic" type="hidden" id="selecttopic" value="imagegallery" />
  ...
  frmvalidator.addValidation("imageurl","req","Please Upload Wallpaper");
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#ECCF5E">
    <tr>
      <td align="center" bgcolor="#FAF1D1" class="texts"><a href="imagegallery.php" class="textsmallred">Back To Image Gallery</a></td>
    </tr>
  </table>
  <table width="40" border="0" cellpadding="0" cellspacing="0">
    <tr>
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
      <td background="images/leftNavBg.png" class="admintitle">UPDATE Image</td>
      </tr>
  </table>
                    <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
...
?>
                          ...
                          <input name="imageid" type="hidden" id="imageid" value="<?php echo $row_blogupdate['imageid']; ?>" />
