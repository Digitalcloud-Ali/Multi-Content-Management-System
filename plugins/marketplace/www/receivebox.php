      ...
      <tr>
        ...
        <td valign="top"><div class="title">My Account</div>
                 <table class="tables">
                    ...
                    <tr>
                      <td colspan="2"><div class="title">Received Messages</div>
                        <table width="100%">
                          <tr>
                            <td width="48%"><strong>Messages</strong></td>
                            <td width="10%" align="center"><strong>FROM</strong></td>
                            <td width="10%" align="center">On Product</td>
                          </tr>
                        </table>
                        <?php do { ?>
                          <table width="100%">
                            <tr>
                              ...
                              <td width="10%" align="center"><a href="send.php?users=<?php echo $row_receivedmessages['from']; ?>&marketid=<?php echo $row_receivedmessages['marketid']; ?>"><?php echo $row_receivedmessages['from']; ?></a></td>
                              <td width="10%" align="center"><a href="market.php?marketid=<?php echo $row_receivedmessages['marketid']; ?>" target="_blank">Check</a></td>
                            </tr>
                          </table>
                          <?php } while ($row_receivedmessages = mysqli_fetch_assoc($receivedmessages)); ?></td>
                      </tr>
                  </table></td>
        <?php
