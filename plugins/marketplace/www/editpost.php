...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "adpost")) {
  ...
  $updateSQL = sprintf("UPDATE market SET title=%s, `description`=%s, imageurl=%s, marketurl=%s, owner=%s, `date`=%s, catename=%s, status=%s, rating=%s, views=%s, `position`=%s, users=%s WHERE marketid=%s",
                       GetSQLValueString($_POST['title'], "text"),
                       GetSQLValueString($_POST['description'], "text"),
                       GetSQLValueString($filename, "text"),
                       GetSQLValueString($_POST['marketurl'], "text"),
...
if (isset($_GET['marketid'])) {
  $colname_recordupdate = $_GET['marketid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_recordupdate = sprintf("SELECT * FROM market WHERE marketid = %s", GetSQLValueString($colname_recordupdate, "int"));
...
?>
                            ...
                            <tr>
                              ...
                              <td><input name="price" type="text" class="formmenusimple" id="price" value="<?php echo $row_recordupdate['price']; ?>" />
                        ...
                        <input name="marketid" type="hidden" id="marketid" value="<?php echo $row_recordupdate['marketid']; ?>">
