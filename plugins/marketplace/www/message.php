...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_message = sprintf("SELECT * FROM marketmessage WHERE users = %s", GetSQLValueString($colname_message, "text"));
...
<table class="tables">
      <tr>
        <td><form action="<?php echo $editFormAction; ?>" method="POST" name="commentform" target="_blank" id="commentform">
          <table>
              <tr>
