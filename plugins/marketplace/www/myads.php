                        ...
                        <?php do { ?>
                            <table width="100%" border="0" cellpadding="2" cellspacing="2">
                              <tr>
                                ...
                                <td width="10%" align="center"><a href="editpost.php?marketid=<?php echo $row_posts['marketid']; ?>">Edit</a></td>
                                <td width="10%" align="center"><a href="deletepost.php?marketid=<?php echo $row_posts['marketid']; ?>">Delete</a></td>
                              </tr>
                            </table>
