                          ...
                          <?php do { ?>
                            <table width="100%">
                              <tr>
                                ...
                                <td width="10%"><a href="editpost.php?blogid=<?php echo $row_posts['blogid']; ?>">Edit</a></td>
                                <td width="10%"><a href="deletepost.php?blogid=<?php echo $row_posts['blogid']; ?>">Delete</a></td>
                              </tr>
                            </table>
