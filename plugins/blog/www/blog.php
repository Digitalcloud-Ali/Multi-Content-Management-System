...
<title><?php echo multicms_h($row_blog['title']); ?></title>
<meta name="keywords" content="<?php echo multicms_h($row_blog['metakey']); ?>">
<meta name="description" content="<?php echo multicms_h($row_blog['metadesc']); ?>">
