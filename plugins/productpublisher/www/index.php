...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_productpublisher = "SELECT * FROM productpublisher WHERE status = 'published' ORDER BY productpublisherid DESC";
...
<?php include($theme_path."".$row_setting['theme']."/header.php"); ?><table class="mainbody">
      <tr>
        ...
        <td valign="top">
  <?php if ($totalRows_productpublisher > 0) { // Show if recordset not empty ?>
<div class="title">NEW PRODUCTS</div>
            <?php do { ?>
                  <table>
                    ...
                    <tr>
                      <td colspan="2"><?php echo multicms_h($row_productpublisher['catename']); ?></td>
                    </tr>
                  </table>
