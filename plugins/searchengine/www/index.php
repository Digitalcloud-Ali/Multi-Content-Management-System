...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_searchengine = "SELECT * FROM searchengine WHERE status = 'published' ORDER BY searchengineid DESC";
...
<div align="center" class="mainbody">
         <div style="height:100px;padding-top:60px;"><a href="/"><img src="/images/<?php echo $row_setting['logo']; ?>" border="0"></a></div>
          <div style="width:499px;"><form name="form1" method="get" action="search.php">
            <input name="title" type="text" class="formsearch" id="title" size="66"></td>
             <input name="button" type="submit" class="button" id="button" value="Search">
          </form>
          <div align="right"><a href="advance.php" class="textsmall">ADVANCE SEARCH</a></div></div>
</div>
