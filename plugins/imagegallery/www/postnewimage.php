...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "adpost")) {
  ...
  $insertSQL = sprintf("INSERT INTO image (title, `description`, imageurl, `date`, catename, status, rating, views, `position`, users) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
      ...
      <tr>
        ...
        <td valign="top"><div class="title">My Account</div>
                  <table class="tables">
                    ...
                    <tr>
                      <td colspan="2"><div class="title">Add Image</div>
