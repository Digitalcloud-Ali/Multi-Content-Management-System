...
<?php include($theme_path."".$row_setting['theme']."/header.php"); ?><table class="mainbody">
      <tr>
        ...
        <td valign="top">
		<div class="title"><?php echo multicms_h($row_image['catename']); ?></div>
		<?php if ($totalRows_image > 0) { // Show if recordset not empty ?>
            <?php do { ?>
              <table>
                <tr>
                  <td class="orangetitle" colspan="2"><a href="image.php?imageid=<?php echo $row_image['imageid']; ?>" class="posttitle"><?php echo multicms_h($row_image['title']); ?></a></td>
                </tr>
                <tr>
