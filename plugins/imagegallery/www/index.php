		...
		<?php if ($totalRows_image > 0) { // Show if recordset not empty ?>
            <?php do { ?>
              <table>
                ...
                <tr>
                  <td width="24" rowspan="2"><a href="image.php?imageid=<?php echo $row_image['imageid']; ?>"><img src="images/gallery/<?php echo $row_image['imageurl']; ?>" width="115" height="97" border="0"></a></td>
                </tr>
                <tr>
