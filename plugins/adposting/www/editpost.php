...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "adpost")) {
  ...
  $updateSQL = sprintf("UPDATE adposting SET title=%s, `description`=%s, imageurl=%s, adpostingurl=%s, owner=%s, `date`=%s, catename=%s, status=%s, rating=%s, views=%s, `position`=%s, users=%s WHERE adpostingid=%s",
...
if (isset($_GET['adpostingid'])) {
  $colname_recordupdate = $_GET['adpostingid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_recordupdate = sprintf("SELECT * FROM adposting WHERE adpostingid = %s", GetSQLValueString($colname_recordupdate, "int"));
...
?>
<?php require_once (defined('MULTICMS_ROOT') ? MULTICMS_ROOT : dirname(__DIR__, 3)) . '/configuration.php'; ?>
<!-- code start -->
<?php
                 ...
                 <table class="tables">
                    ...
                    <tr>
                      <td colspan="2"><div class="title">Update Product For Market</div>
                        ...
                        <table width="100%" height="197" border="0" cellpadding="0" cellspacing="4" style="margin-left:15px; margin-top:15px;">
                            <tr>
                              <td width="101" height="22" class="texts"><strong>TITLE:*</strong></td>
                              <td width="728"><input name="title" type="text" class="form" id="title" value="<?php echo $row_recordupdate['title']; ?>" required="required" pattern="[a-zA-Z0-9 ]+" title="No Special Characters Allowed"></td>
                              </tr>
                            <tr>
                              <td height="23" valign="top" class="texts"><strong>DESCRIPTION:*</strong></td>
                              <td><textarea name="description" cols="55" rows="5" class="wysiwyg" id="description" required="required"><?php echo $row_recordupdate['description']; ?></textarea></td>
                              </tr>
                            <tr>
                              <td height="24" class="texts"><strong>DATE:</strong>*</td>
                              <td><input name="date" type="text" class="formmenusimple" id="date" value="<?php echo $row_recordupdate['date']; ?>" required="required">
...
?>
                            ...
                            <tr>
                              ...
                              <td><input name="imageurl" type="file" class="formmenusimple" id="imageurl" value="<?php echo $row_recordupdate['imageurl']; ?>" /></td>
                              </tr>
                            <tr>
                              <td height="24" class="texts"><strong>AD Url:</strong></td>
                              <td><input name="adpostingurl" type="text" class="form" id="adpostingurl" value="<?php echo $row_recordupdate['adpostingurl']; ?>"></td>
                            </tr>
                            <tr>
                              <td height="24">&nbsp;</td>
                        ...
                        <input name="adpostingid" type="hidden" id="adpostingid" value="<?php echo $row_recordupdate['adpostingid']; ?>">
