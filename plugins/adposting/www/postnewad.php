                      ...
                      <td colspan="2"><div class="title">Create New Post</div>
                        ...
                        <table width="100%" height="197" border="0" cellpadding="0" cellspacing="4" style="margin-left:15px; margin-top:15px;">
                            <tr>
                              ...
                              <td width="728"><input name="title" type="text" class="form" id="title" pattern="[a-zA-Z0-9 ]+" title="No Special Characters Allowed" required="required"></td>
                            </tr>
                            <tr>
                              <td height="23" valign="top" class="texts"><strong>DESCRIPTION:*</strong></td>
                              <td><textarea name="description" cols="55" rows="5" class="wysiwyg" id="description" required="required"></textarea></td>
                            </tr>
                            <tr>
                              <td height="24" class="texts"><strong>DATE:*</strong></td>
                              <td><input name="date" type="text" class="formmenusimple" id="date" value="<?php print(date("d-m-Y")); ?>" required="required">
...
?>
                            ...
                            <tr>
                              ...
                              <td><input name="imageurl" type="file" class="formmenusimple" id="imageurl" required="required" /></td>
                            </tr>
                            <tr>
