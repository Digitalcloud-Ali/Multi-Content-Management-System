              ...
              <td><form name="form1" method="post" action="raq.php">
                <table>
                  ...
                  <tr>
                    ...
                    <td><input name="phone" type="number" class="form" id="phone" placeholder="your phone number" required="required" min="2" max="20"></td>
                  </tr>
                  <tr>
                    <td class="texts"><strong>PROJECT TITLE:*</strong></td>
                    <td><input name="projecttitle" type="text" class="form" id="projecttitle" min="2" max="50" required="required"></td>
                  </tr>
                  <tr>
                    <td valign="top" class="texts"><strong>PROJECT DETAIL:*</strong></td>
