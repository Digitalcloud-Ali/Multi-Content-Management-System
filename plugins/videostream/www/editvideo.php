...
if (isset($_GET['videoid'])) {
  $colname_recordupdate = $_GET['videoid'];
}
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_recordupdate = sprintf("SELECT * FROM video WHERE videoid = %s", GetSQLValueString($colname_recordupdate, "int"));
      ...
      <tr>
        ...
        <div class="title">My Account</div>
                 <table class="tables">
                    ...
                    <tr>
                      <td colspan="2"><div class="title">Post New Video</div>
...
?>
                            ...
                            <tr>
                              ...
                              <td><select name="videotype" class="formmenu" id="videotype">
                                <option value="video" <?php if (!(strcmp("video", $row_recordupdate['videotype']))) {echo "selected=\"selected\"";} ?>>video</option>
                                <option value="embed" <?php if (!(strcmp("embed", $row_recordupdate['videotype']))) {echo "selected=\"selected\"";} ?>>embed</option>
                              </select></td>
                            </tr>
                            <tr>
                              <td height="24" class="texts"><strong>VIDEO PATH:</strong></td>
                              <td><input name="videourl" type="file" class="formmenusimple" id="videourl" /><?php echo $row_recordupdate['videourl']; ?></td>
                            </tr>
                            <tr>
                              <td height="23" valign="top" class="texts"><strong>EMBED CODE:</strong></td>
                              <td><textarea name="embedcode" cols="55" rows="5" class="formtextarea" id="embedcode"><?php echo $row_recordupdate['embedcode']; ?></textarea></td>
                            </tr>
                            <tr>
                              <td height="24">&nbsp;</td>
                        ...
                        <input name="videoid" type="hidden" id="videoid" value="<?php echo $row_recordupdate['videoid']; ?>">
