...
if ((isset($_GET['tutorialsmessageid'])) && ($_GET['tutorialsmessageid'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tutorialsmessage WHERE tutorialsmessageid=%s",
                       GetSQLValueString($_GET['tutorialsmessageid'], "int"));

  mysqli_select_db(dbconnect(),$database_rayicecms);
  $Result1 = mysqli_query(dbconnect(),$deleteSQL) or die(mysqli_connect_error());

  $deleteGoTo = "mytutorials.php";
