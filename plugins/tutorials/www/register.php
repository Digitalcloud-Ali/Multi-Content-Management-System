      ...
      <td><form action="<?php echo $editFormAction; ?>" method="POST" name="registerbox" id="registerbox">
        <table class="texts" style="margin-left:15px;">
          <tr>
            ...
            <td><input type="text" class="form" name="users" id="users" min="4" maxlength="20" pattern="[a-zA-Z0-9]+" title="No Special Characters Allowed" required="required">
              <?php 
          ...
          <tr>
            ...
            <td><input type="text" class="form" name="state" min="5" maxlength="15" id="state" pattern="[a-zA-Z0-9]+" title="No Special Characters Allowed"  required="required"></td>
            </tr>
          <tr>
...
<option value="Zimbabwe">Zimbabwe</option>
          ...
          <tr>
            ...
            <td><input type="number" class="form" min="10" maxlength="25" name="phone" id="phone" required="required"></td>
            </tr>
          <tr>
        ...
        <input name="level" type="hidden" id="level" value="member" /></form>
        </td>
      </tr>
  </table>
