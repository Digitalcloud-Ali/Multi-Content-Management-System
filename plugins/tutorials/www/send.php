...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_receivedmessages = sprintf("SELECT * FROM tutorialsmessage WHERE users = %s AND status1 = 'received'", GetSQLValueString($colname_receivedmessages, "text"));
...
mysqli_select_db(dbconnect(),$database_rayicecms);
$query_messages = sprintf("SELECT * FROM tutorialsmessage WHERE users = %s", GetSQLValueString($colname_messages, "text"));
                    ...
                    <tr>
                      <td colspan="2"><div class="title">Create Message</div>
                        <form action="<?php echo $editFormAction; ?>" method="POST" name="commentform" id="commentform">
                          <table class="tables">
                            <tr>
                              <td width="10%" class="texts"><strong>SUBJECT:</strong></td>
                            ...
                            <tr>
                              <td height="22"><input name="tutorialsid" type="hidden" id="tutorialsid" value="<?php echo $_GET["tutorialsid"]; ?>">
