...
if(($rightmenu['status'] == 'active') && ($leftmenu['status'] == 'disabled'))
{
?>
...
?>
	<?php
	$lrads_query = mysqli_query(dbconnect(),"SELECT * FROM parts WHERE partsid = '16'");
	$lrads = mysqli_fetch_assoc($lrads_query);
	if($adsmanagement['status'] == 'active')
	{
	?>
		<div class="title">ADVERTISEMENT</div>
		<div align="center"><?php echo $settings['ad2']; ?></div>
	<?php
	}
	?>
<?php
