...
<p class="lead"><?php echo htmlspecialchars(getSetting('site_description', 'MultiCMS is a modern content management system with optional ready-made site plugins.')); ?></p>
